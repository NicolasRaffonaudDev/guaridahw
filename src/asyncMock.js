const products = [
    ...
    { id: 6, name: "Corsair CV550 550W", price: 10000, category: "power_supply", img: "", stock: 100, description: "Fuente de poder Corsair CV550 de 550W." },
    { id: 7, name: "Cooler Master MasterBox Q300L", price: 12000, category: "case", img: "", stock: 75, description: "Gabinete Cooler Master MasterBox Q300L, compacto y eficiente." },
    { id: 8, name: "Seagate Barracuda 1TB", price: 8000, category: "storage", img: "", stock: 200, description: "Disco Duro Seagate Barracuda de 1TB." },
    { id: 9, name: "Corsair H100i", price: 25000, category: "cooling", img: "", stock: 30, description: "Refrigeración líquida Corsair H100i para alto rendimiento." },
    { id: 10, name: "LG 24' Full HD", price: 30000, category: "monitor", img: "", stock: 60, description: "Monitor LG de 24 pulgadas con resolución Full HD." },
    { id: 11, name: "AMD Ryzen 5 5600X", price: 48000, category: "processor", img: "", stock: 90, description: "Procesador AMD Ryzen 5 5600X, 6 núcleos." },
    { id: 12, name: "Gigabyte GeForce GTX 1660 Super", price: 90000, category: "graphics_card", img: "", stock: 45, description: "Placa de video GTX 1660 Super, ideal para juegos." },
